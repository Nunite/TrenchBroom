...
TEST_CASE("Map_Brushes")
{
  ...
  SECTION("setTriangleUVs")
  {
    ...
    const auto originalOtherFace = getFace(*brushNode, 1u);
    ...
    CHECK_THAT(getFace(*brushNode, 1u), MatchesBrushFaceAttributes(originalOtherFace));
    ...
    SECTION("Returns false for non parallel UV map formats")
    {
      ...
      const auto standardBuilder = BrushBuilder{
        ...
        standardMap.gameInfo().gameConfig.faceAttribsConfig.defaultUvAttributes,
        standardMap.gameInfo().gameConfig.faceAttribsConfig.defaultSurfaceAttributes};
      ...
      const auto originalFace = getFace(*standardBrushNode, *standardFaceIndex);
      ...
      CHECK_THAT(unchangedFace, MatchesBrushFaceAttributes(originalFace));
  ...
  SECTION("setFaceUVs")
  {
    ...
    {
      const auto beforeFace = changedFace;
      ...
      CHECK_THAT(unchangedFace, MatchesBrushFaceAttributes(beforeFace));
