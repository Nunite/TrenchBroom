  ...
  SECTION("Regression tests")
  {
    ...
    SECTION("constructWithFailingFaces5")
    {
      /* from jam6_ericwtronyn
       Interestingly, the order in which the faces appear in the map file is okay, but
       when they get reordered during load, the resulting order leads to a crash. The
       order below is the reordered one.
       */
    ...
    SECTION("constructWithFailingFaces6")
    {
      /* from 768_negke
       {
       ( -80 -80 -3840  ) ( -80 -80 -3824  ) ( -32 -32 -3808 ) mmetal1_2b 0 0 0 1 1 //
       front / right ( -96 -32 -3840  ) ( -96 -32 -3824  ) ( -80 -80 -3824 ) mmetal1_2 0 0
       0 1 1
       // left ( -96 -32 -3824  ) ( -32 -32 -3808  ) ( -80 -80 -3824 ) mmetal1_2b 0 0 0 1
       1
       // top ( -32 -32 -3840  ) ( -32 -32 -3808  ) ( -96 -32 -3824 ) mmetal1_2b 0 0 0 1 1
       // back ( -32 -32 -3840  ) ( -96 -32 -3840  ) ( -80 -80 -3840 ) mmetal1_2b 0 0 0 1
       1
       // bottom
       }
       */
      ...
      const auto brush =
        Brush::create(
          worldBounds,
          {
            ...
            createParaxial(
              {536, 792, -480}, {536, 792, -432}, {488, 720, -480}, "face12"),
            createParaxial(
              {568, 656, -464}, {568, 648, -480}, {520, 672, -456}, "face14"),
            createParaxial(
              {520, 672, -456}, {520, 664, -480}, {488, 720, -452}, "face15"),
            createParaxial(
              {560, 728, -440}, {488, 720, -452}, {536, 792, -432}, "face17"),
            createParaxial(
              {568, 656, -464}, {520, 672, -456}, {624, 688, -456}, "face19"),
            createParaxial(
              {560, 728, -440}, {624, 688, -456}, {520, 672, -456}, "face20"),
            createParaxial(
              {600, 840, -480}, {536, 792, -480}, {636, 812, -480}, "face22"),
          })
        | kdl::value();
    ...
    SECTION("removeVertexWithCorrectMaterials_2082")
    {
      ...
      // Make sure that the faces have the materials we expect before the vertex is
      // deleted.
    ...
    SECTION("subtractTruncatedCones")
    {
      ...
      const auto& minuend =
        static_cast<BrushNode*>(minuendNodes.value().front())->brush();
      const auto& subtrahend =
