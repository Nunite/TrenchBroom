          ...
          static PyMethodDef methods[] = {
            ...
            {"add_plugin_panel",
             [](PyObject*, PyObject* args) -> PyObject* {
               ...
               {
                 PyErr_SetString(PyExc_RuntimeError, "No active MapWindow");
                 return nullptr;
               }
               try
               {
...
void PythonScripting::onSelectionChanged(MapWindow& frame)
{
...
void PythonScripting::onDocumentSaved(MapWindow& frame)
{
  if (!g_pythonRegistered || !Py_IsInitialized())
  {
    return;
