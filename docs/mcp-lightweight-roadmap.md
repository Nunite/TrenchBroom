...
| --- | --- | --- | --- |
| P1 | Normalize `idsMode` across high-volume tools | C++ MCP | Partial: IR apply, selector preview, transform, review, entity/texture/asset/problem mutations, and object deletes have compact defaults; remaining brush create/history/resource paths need another sweep. |
