...
If you have an idea for a feature that is missing from TrenchBroom, you can submit a request at the [TrenchBroom issue tracker]. Try to describe your feature, but don't go into too much detail. If it gets picked up, we will work out the details together.
...
- *Operating system and version*: e.g. "Windows 7 64-bit"
